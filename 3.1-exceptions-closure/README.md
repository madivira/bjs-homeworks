...
1. Напишите класс `Triangle`
    ...
    * В случае нарушения правила существования треугольника (сумма двух сторон меньше третьей) "Треугольник с такими сторонами не существует"*.выбрасывайте исключение с ошибкой *
